//
//  MakePaymentWithSavedMethod_PaymentFieldsViewController.swift
...
class MakePaymentWithSavedMethod_PaymentFieldsViewController: UIViewController {
    var savePaymentMethod: Bool = false
    var selectedPaymentOption: MakePaymentWithSavedMethod_PaymentMethodOption!
    var orderId: String!
   ...
   @objc func notifyKeyboardWillHide(_ notification: NSNotification){
    ...
    private func generatePaymentDetails(selectedPaymentOption: MakePaymentWithSavedMethod_PaymentMethodOption!) -> [String: Any] {
...
extension MakePaymentWithSavedMethod_PaymentFieldsViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "PaymentFieldCell", for: indexPath) as! MakePaymentWithSavedMethod_PaymentFieldTableViewCell
    ...
    func tableView(_ tableView: UITableView, viewForFooterInSection section: Int) -> UIView? {
        ...
        btn_checkout.setTitle("Pay with Saved Payment Method", for: .normal)
...
extension MakePaymentWithSavedMethod_PaymentFieldsViewController: InaiCheckoutDelegate {
