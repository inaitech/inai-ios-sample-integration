//
//  ValidateFieldsOptionsViewController.swift
...
class ValidateFieldsOptionsViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "ShowValidateFieldsView" {
            if let vc = segue.destination as? ValidateFieldsViewController {
...
extension ValidateFieldsOptionsViewController: UITableViewDataSource, UITableViewDelegate {
